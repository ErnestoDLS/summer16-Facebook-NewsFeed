...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Article = __webpack_require__(223);

	var _Article2 = _interopRequireDefault(_Article);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	redner(_react2.default.createElement(
	  _reactRouter.Router,
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement('img', { className: 'author__avatar', src: this.props.author__img }),
	        _react2.default.createElement(
	          'h2',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Comment = __webpack_require__(225);
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      this.props.comments.map(function (comment, i) {
	        return _react2.default.createElement(_Comment2.default, { key: i, author_name: comment.author_name, author_img: comment.author_img, text: comment.text, date: comment.date });
	      })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      "article",
	      { className: "comments__article" },
	      _react2.default.createElement(
	        "div",
	        { className: "comments__detail--wrapper" },
	        _react2.default.createElement("img", { className: "comments__avatar", src: this.props.author__img }),
	        _react2.default.createElement(
	          "h2",
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.creatClass({
	  componentWillMount: function componentWillMount() {
	    this.setState({ liked: false });
	    this.setState({ commented: false });
	  },
	  onHandleClickLike: function onHandleClickLike(e) {
	    this.setState({ liked: this.state.liked ? false : true });
	    e.preventDefault();
	  },
	  onHandleClickComment: function onHandleClickComment(e) {
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        "h2",
	        { className: this.stated.liked ? "like_article--clicked" : "like_article", onClick: this.onHandleClickLike },
	        "Like"
	      ),
	      _react2.default.createElement("h2", { className: this.state.commented ? "comment_article--clicked" : "comment_article", onClick: this.onHandleClickComment })
	    );
	  }
	});
